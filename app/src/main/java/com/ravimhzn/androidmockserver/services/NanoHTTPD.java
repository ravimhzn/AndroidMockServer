...
public abstract class NanoHTTPD {
    ...
    public static class Response {
        ...
        public enum Status implements IStatus {
            SWITCH_PROTOCOL(101, "Switching Protocols"), OK(200, "OK"), CREATED(201, "Created"), ACCEPTED(202, "Accepted"), NO_CONTENT(204, "No Content"),
            PARTIAL_CONTENT(206, "Partial Content"), REDIRECT(301, "Moved Permanently"), NOT_MODIFIED(304, "Not Modified"), BAD_REQUEST(400, "Bad Request"),
            UNAUTHORIZED(401, "Unauthorized"), FORBIDDEN(403, "Forbidden"), NOT_FOUND(404, "Not Found"), METHOD_NOT_ALLOWED(405, "Method Not Allowed"),
            LOCKED(423, "LOCKED"), I_AM_A_TEAPOT(418, "I am a teapot"), NOT_ACCEPTABLE(406, "Not acceptable"),
            RANGE_NOT_SATISFIABLE(416, "Requested Range Not Satisfiable"), INTERNAL_ERROR(500, "Internal Server Error"), NOT_IMPLEMENTED(501, "Not Implemented"),
            SERVICE_UNAVAILABLE(503, "Service Unavailable"), GATEWAY_TIMEOUT(504, "Gateway Timeout");
    ...
    public static class Cookie {
        private String name, value, expires;
        ...
        public String getHTTPHeader() {
            ...
            return String.format(fmt, name, value, expires);
        }
    }
